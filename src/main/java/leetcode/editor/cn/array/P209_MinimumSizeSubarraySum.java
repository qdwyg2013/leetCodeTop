...
//                // 子序列的数值之和
//                int sum = 0;
//                // 1.设置子序列终止位置为j (注意此处从j=i开始，若从i+1开始，for外面还需做一次if判断)
...
//                        // 2.因为我们是找符合条件最短的子序列，所以一旦符合条件就break
//                        break;
//                    }
//                }
//            }
//
//            // 3.如果minSubArrayLen没有被赋值的话，就返回0，说明没有符合条件的子序列
